...
//	OLED_ShowString(byte(8),line8,"YAW:",6);
    ...
    OLED_ShowString(byte(0),line1,"SEND --->",6); //摇杆发送数据
	OLED_ShowString(byte(0),line2,"THR:",6);
	OLED_ShowString(byte(8),line2,"PIT:",6);
	OLED_ShowString(byte(0),line3,"YAW:",6);
	OLED_ShowString(byte(8),line3,"ROL:",6);
	
	OLED_ShowString(byte(0),line5,"BACK <---",6); //飞机发来数据
	OLED_ShowString(byte(0),line6,"THR:",6);
	OLED_ShowString(byte(8),line6,"PIT:",6);
	OLED_ShowString(byte(0),line7,"YAW:",6);
	OLED_ShowString(byte(8),line7,"ROL:",6);
	OLED_ShowString(byte(0),line8,"ALT:",6);
	OLED_ShowString(byte(8),line8,"MOD:",6);
...
//		percent = (FLY.BattV-300.0f)/120.f*100; //电池百分比
		...
		OLED_ShowNum(byte(4),line6,FLY.Thr,4,6);  //油门
		//	OLED_ShowNum(byte(11),line4,1500,4,6);
		OLED_ShowNum(byte(12),line7,FLY.Rol,2,6);  //横滚角
		OLED_ShowNum(byte(12),line6,FLY.Pit,2,6); //俯仰角
		OLED_ShowNum(byte(4),line7,FLY.Yaw,2,6); //航向角
		OLED_ShowNum(byte(4),line8,FLY.Alt,2,6);  //高度
//		OLED_ShowNum(108,line2,percent,2,6); //电池电压比例
	}
...
{
    OLED_ShowNum(byte(4),line2,ADC_Value[2],4,6);  //油门
	OLED_ShowNum(byte(12),line2,ADC_Value[0],4,6); //俯仰角
	OLED_ShowNum(byte(4),line3,ADC_Value[3],4,6);  //航向角
	OLED_ShowNum(byte(12),line3,ADC_Value[1],4,6); //横滚角
}
